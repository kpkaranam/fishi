 ...
 */
export function mergeClaudeMdTop(existing: string, fishiContent: string): string {
  ...
  if (startIdx !== -1 && endIdx !== -1) {
    // Replace existing FISHI section (idempotent)
    const sectionEnd = endIdx + FISHI_END.length;
    // Skip any trailing --- separator and newline after the FISHI block
