...
export function planningAgentTemplate(ctx: TemplateContext): string {
  return `---
name: planning-agent
...
You are a planning specialist for the **${ctx.projectName}** project.
...
Append to .fishi/logs/actions/planning-agent-actions.md:
