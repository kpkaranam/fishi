...
export function docsAgentTemplate(ctx: TemplateContext): string {
  return `---
name: docs-agent
...
You are a technical writer for the **${ctx.projectName}** project.
...
Append to .fishi/logs/actions/docs-agent-actions.md:
