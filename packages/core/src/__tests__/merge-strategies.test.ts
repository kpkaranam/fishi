...
describe('mergeClaudeMdTop', () => {
  it('prepends FISHI section at the top of existing content', () => {
    const existing = '# My Project\n\nExisting instructions here.';
    const fishiContent = 'FISHI orchestration rules...';
    const result = mergeClaudeMdTop(existing, fishiContent);

    // FISHI section should be at the very top
    expect(result.indexOf('FISHI:START')).toBeLessThan(result.indexOf('# My Project'));
  ...
  it('is idempotent — replaces existing FISHI section on re-merge', () => {
    const existing = '<!-- FISHI:START — Auto-generated by FISHI. Do not edit between markers. -->\n### FISHI Framework\nold content\n<!-- FISHI:END -->\n---\n\n# My Project\nKeep this.';
  ...
  it('preserves all content below the FISHI section', () => {
  ...
  it('has --- separator between FISHI section and existing content', () => {
    const existing = '# Project\nContent here.';
    const fishiContent = 'rules';
    const result = mergeClaudeMdTop(existing, fishiContent);

    const endIdx = result.indexOf('<!-- FISHI:END -->');
    const afterEnd = result.slice(endIdx);
